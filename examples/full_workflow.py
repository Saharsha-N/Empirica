# This script runs the full workflow of Empirica.
...
def download_data(workdir):
    ...
    for file in csv_files:
        ...
        if not os.path.isfile(outfile):
            ...
            url = f"https://users.flatironinstitute.org/~fvillaescusa/Empirica/Astrophysics/GW/data/{file}"
...
astro_pilot = Empirica(project_dir=project_dir)
