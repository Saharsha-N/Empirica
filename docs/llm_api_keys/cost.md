...
New users are likely to encounter token rate limits when using OpenAI models. This may cause Empirica to pause temporarily if too much text or code is generated. To increase token rate limits, refer to [OpenAI's rate limit documentation](https://platform.openai.com/docs/guides/rate-limits).

If rate limits are a problem for you, please contact us at [empirica.astropilot.ai@gmail.com](mailto:empirica.astropilot.ai@gmail.com).
