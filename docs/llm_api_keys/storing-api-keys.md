...
Copy and paste the above lines directly into your terminal session, where Empirica will be running.

## Create a `.env` File

In the directory where Empirica will be run, create a `.env` file containing:
